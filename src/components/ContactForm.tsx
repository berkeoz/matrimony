...
export default function ContactForm() {
  ...
  if (sent) {
    return (
      <p className="rounded-2xl border border-green-200 bg-green-50 p-6 text-sm text-green-800 dark:border-green-900/40 dark:bg-green-950/40 dark:text-green-300">
